var fav_pizza = ['stuffed cruest', 'fajita', 'barbq'];
for (var i = 0; i < fav_pizza.length; i++) {
    if (fav_pizza[i] === "stuffed cruest") {
        console.log("The stuffed cruestis avaliable at cheezious");
    }
    else if (fav_pizza[i] === 'fajita') {
        console.log("The fajita is very famouse");
    }
